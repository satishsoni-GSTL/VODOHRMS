<x-filament-panels::page>
    <div class="fi-section rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
        <p class="mb-4 text-sm text-gray-600 dark:text-gray-400">
            Download the template, fill in daily attendance rows, then upload it below. Records are previewed and
            validated before anything is written &mdash; conflicts with existing attendance are skipped unless you
            explicitly choose to overwrite them.
        </p>
