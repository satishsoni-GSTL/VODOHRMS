...
class ImportEmployees extends Page implements HasForms, HasTable
{
    ...
    {
        return auth()->user()?->can('employee.import') ?? false;
    }
    ...
    public function uploadAndValidate(): void
    {
        ...
        $batch = ImportBatch::create([
            'importable_type' => ImportBatch::TYPE_EMPLOYEE,
        ...
        app(EmployeeImportService::class)->validateBatch($batch);
    ...
    public function confirmImport(): void
    {
        ...
        app(EmployeeImportService::class)->importBatch($batch, auth()->user());

        Notification::make()
            ->title("Imported {$batch->refresh()->success_rows} employees successfully")
            ->success()
            ->send();
    }
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('raw_data.first_name')->label('First Name'),
                Tables\Columns\TextColumn::make('raw_data.official_email')->label('Email'),
    ...
    protected function getHeaderActions(): array
    {
        return [
            Action::make('downloadTemplate')
                ...
                ->action(fn () => Excel::download(new EmployeeTemplateExport, 'employee-import-template.xlsx')),
